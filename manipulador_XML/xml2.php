<?php
/**
 * https://linux07/callcenter/rafael/manipulador_XML/xml2.php
 * https://linux03/callcenter/rafael/manipulador_XML/xml2.php
 */
...
try {
  ...
  echo "<br>" . PHP_EOL;
  echo "*** Informações Geográficas *** <br>" . PHP_EOL;
  ...
  if (!is_writable($filename)) {
    throw new Exception("Arquivo {$filename} sem permissão de gravação.<br>" . PHP_EOL);
  }
